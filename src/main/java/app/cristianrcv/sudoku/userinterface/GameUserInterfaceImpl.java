...
import app.cristianrcv.sudoku.game.utils.Coordinates;
 ...
 */
class GameUserInterfaceImpl implements SudokuUserInterface {
    ...
    private UserInterfaceControlLogic listener;
     ...
     * @param stage
     */
    GameUserInterfaceImpl(Stage stage) {
        this.stage = stage;
        this.root = new Group();
    ...
    @Override
    public void setListener(UserInterfaceControlLogic listener) {
